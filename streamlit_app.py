...
def generate_name_recommendation(gender, characteristics, first_letter, language):
    ...
    response = openai.chat.completions.create(
        ...
        max_tokens=450,
        messages=[
            {"role": "system", "content": "Act as a name counselor. You will help users find the most suitable name for the user from the information given by the user. Put the name, origin, meaning in a pandas table. The output must be a table only."},
